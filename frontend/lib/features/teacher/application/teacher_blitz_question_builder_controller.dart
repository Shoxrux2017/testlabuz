...
class TeacherBlitzQuestionBuilderController
  ...
  TeacherQuestionBuilderState build() {
    ...
    final authoritativeChanged = !sameTeacherQuestionOrder(
  ...
  Future<void> _reconcile(
    ...
    try {
      ...
      final proven = switch (pending.operation) {
        ...
        TeacherQuestionMutationOperation.reorder => sameTeacherQuestionOrder(
          teacherQuestionOrder(current.questions),
