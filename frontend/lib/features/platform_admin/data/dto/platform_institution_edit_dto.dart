...
class PlatformInstitutionEditResponseDto {
  const PlatformInstitutionEditResponseDto({
    required this.id,
    required this.name,
    required this.type,
  ...
  factory PlatformInstitutionEditResponseDto.fromJson(
    Object? json, {
    required String requestedInstitutionId,
  }) {
    final envelope = _readRequiredMap(json, 'institution edit envelope');
    final data = _readRequiredMap(envelope['data'], 'institution edit data');
    final id = _readRequiredString(data, 'id');

    if (id != requestedInstitutionId) {
      throw const FormatException(
        'Institution edit response ID did not match request.',
      );
    }

    return PlatformInstitutionEditResponseDto(
      id: id,
  ...
  PlatformInstitutionEditResult toDomain() {
