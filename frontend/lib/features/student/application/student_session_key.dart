...
class StudentSessionSnapshot {
  ...
  factory StudentSessionSnapshot.fromSession(
  ...
  StudentSessionKey? get eligibleKey {
...
class StudentSessionKey {
  const StudentSessionKey({
    required this.userId,
    required this.userInstance,
    required this.institutionId,
    required this.institutionTimezone,
