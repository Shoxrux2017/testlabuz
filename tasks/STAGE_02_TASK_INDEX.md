...
`S02-BE-007`, `S02-FE-001`, `S02-FE-002`, and `S02-FE-003` are accepted and
delivered. `S02-FE-004` passed read-only review, but delivery is blocked. All
later tasks remain planned and may not be started until their own detailed
contracts are approved.
...
| 11 | `S02-FE-004` | Frontend | Institution detail and basic usage presentation | `Delivery Blocked` | `PASS` | `Blocked` | `tasks/frontend/stage-02/S02-FE-004-platform-institution-detail-basic-usage.md` |
...
- [x] `S02-FE-004` passed read-only review, but safe GitHub delivery is blocked.
