...
| Closure | `Not started` |
| Next permitted gate | `S08-FE-003 implementation` |
...
`S08-FE-002` (PR #264) are `Accepted / Delivered`; `S08-FE-003` was revalidated and is
...
| `14` | `S08-FE-003` | `Frontend` | `Teacher official designation, scheduling and lifecycle UX` | `FE-001…002 Accepted / Delivered + Backend Phase 2 PASS` | `Approved` | `Approved — revalidated 2026-09-24 on b5b24b1` | `Not started` | `tasks/frontend/stage-08/S08-FE-003-teacher-blitz-lifecycle-ux.md` |
...
- `Current readiness / review status` is authoritative for task execution.
  ...
  `S08-BE-PHASE-2` is `PASS` (run #2, see §17). `S08-FE-001` and `S08-FE-002` are
  `Accepted / Delivered`. `S08-FE-003` is `Approved / Not started`. All other
...
S08-FE-002 Accepted / Delivered (PR #264, b5b24b1)
    ↓
S08-FE-003 Approved / Not started (revalidated 2026-09-24 on b5b24b1)
    ↓
