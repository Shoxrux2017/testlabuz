...
`S03-FE-001`, `S03-FE-002`, `S03-FE-003`, `S03-FE-004`, and `S03-FE-005` accepted and
delivered. The
...
delivered; the next implementation gate is `S03-FE-006`. Stage 3 is not
