...
| 3 | `S01-BE-001` | Backend | Laravel API scaffold and backend quality/error foundation | `S01-INT-002` | `Approved` | `Not started` | `Not started` | `tasks/backend/stage-01/S01-BE-001-laravel-api-scaffold-quality-foundation.md` |
