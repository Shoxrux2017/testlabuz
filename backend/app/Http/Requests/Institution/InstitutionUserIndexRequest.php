...
class InstitutionUserIndexRequest extends FormRequest
{
    ...
    {
        return [
            'role' => ['sometimes', 'string', Rule::in(ListInstitutionUsers::allowedRoles())],
            ...
            'page' => ['sometimes', 'integer', 'min:'.ListInstitutionUsers::DEFAULT_PAGE],
            'per_page' => [
                'sometimes',
                'integer',
                'min:1',
                'max:'.ListInstitutionUsers::MAX_PER_PAGE,
            ],
            'sort' => ['sometimes', 'string', Rule::in(ListInstitutionUsers::allowedSorts())],
            'direction' => ['sometimes', 'string', Rule::in(ListInstitutionUsers::allowedDirections())],
        ];
    }
    ...
    {
        return (string) $this->validated('sort', ListInstitutionUsers::DEFAULT_SORT);
    }

    public function direction(): string
    {
        return (string) $this->validated('direction', ListInstitutionUsers::DEFAULT_DIRECTION);
    }

    public function page(): int
    {
        return (int) $this->validated('page', ListInstitutionUsers::DEFAULT_PAGE);
    }

    public function perPage(): int
    {
        return (int) $this->validated('per_page', ListInstitutionUsers::DEFAULT_PER_PAGE);
    }
}
