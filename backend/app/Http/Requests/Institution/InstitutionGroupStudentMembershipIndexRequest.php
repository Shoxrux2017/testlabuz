...
class InstitutionGroupStudentMembershipIndexRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'page' => ['sometimes', 'integer', 'min:'.ListInstitutionGroupStudents::DEFAULT_PAGE],
            'per_page' => ['sometimes', 'integer', 'min:1', 'max:'.ListInstitutionGroupStudents::MAX_PER_PAGE],
            'sort' => ['sometimes', 'string', Rule::in(ListInstitutionGroupStudents::allowedSorts())],
            'direction' => ['sometimes', 'string', Rule::in(ListInstitutionGroupStudents::allowedDirections())],
        ];
    }
    ...
    {
        return (string) $this->validated('sort', ListInstitutionGroupStudents::DEFAULT_SORT);
    }

    public function direction(): string
    {
        return (string) $this->validated('direction', ListInstitutionGroupStudents::DEFAULT_DIRECTION);
    }

    public function page(): int
    {
        return (int) $this->validated('page', ListInstitutionGroupStudents::DEFAULT_PAGE);
    }

    public function perPage(): int
    {
        return (int) $this->validated('per_page', ListInstitutionGroupStudents::DEFAULT_PER_PAGE);
    }
}
