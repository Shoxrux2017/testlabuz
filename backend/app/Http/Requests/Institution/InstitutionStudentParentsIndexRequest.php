...
class InstitutionStudentParentsIndexRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'page' => ['sometimes', 'integer', 'min:'.ListInstitutionStudentParents::DEFAULT_PAGE],
            'per_page' => ['sometimes', 'integer', 'min:1', 'max:'.ListInstitutionStudentParents::MAX_PER_PAGE],
            'sort' => ['sometimes', 'string', Rule::in(ListInstitutionStudentParents::allowedSorts())],
            'direction' => ['sometimes', 'string', Rule::in(ListInstitutionStudentParents::allowedDirections())],
        ];
    }
    ...
    {
        return (string) $this->validated('sort', ListInstitutionStudentParents::DEFAULT_SORT);
    }

    public function direction(): string
    {
        return (string) $this->validated('direction', ListInstitutionStudentParents::DEFAULT_DIRECTION);
    }

    public function page(): int
    {
        return (int) $this->validated('page', ListInstitutionStudentParents::DEFAULT_PAGE);
    }

    public function perPage(): int
    {
        return (int) $this->validated('per_page', ListInstitutionStudentParents::DEFAULT_PER_PAGE);
    }
}
